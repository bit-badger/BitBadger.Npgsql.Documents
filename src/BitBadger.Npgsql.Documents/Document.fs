...
module WithProps =
    ...
    module Find =
        ...
        let ById<'T when 'T: null>(
            tableName: string, docId: string, sqlProps: Sql.SqlProps
        ...
        let ByContains<'T>(
            tableName: string, criteria: obj, sqlProps: Sql.SqlProps
        ...
        let ByJsonPath<'T>(
            tableName: string, jsonPath: string, sqlProps: Sql.SqlProps
        ) : Task<ResizeArray<'T>> = backgroundTask {
        ...
        let FirstByContains<'T when 'T: null>(
            tableName: string, criteria: obj, sqlProps: Sql.SqlProps
        ) : Task<'T> = backgroundTask {
        ...
        let FirstByJsonPath<'T when 'T: null>(
            tableName: string, jsonPath: string, sqlProps: Sql.SqlProps
        ) : Task<'T> = backgroundTask {
    ...
    module Update =
        ...
        /// Update a document
        let FullFunc<'T>(tableName: string, idFunc: System.Func<'T, string>, document: 'T, sqlProps: Sql.SqlProps) =
